...
export default function CTASection() {
  ...
  return (
    <section
      id="iletisim"
      className="relative w-full bg-[#04090d] pt-20 pb-28 lg:pt-28 lg:pb-36 px-5 sm:px-8 lg:px-12 xl:px-16 overflow-visible"
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(202,168,105,0.15) 0%, transparent 70%)" }}
      />

      {/* Full-width container — same padding as gallery, no max-width cap */}
      <div className="w-full relative z-10">
        
        {/* 2-column grid: left contact ~35%, right form ~65% */}
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.85fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-10 lg:sticky lg:top-[120px] h-fit">
            <div>
              ...
              >
                Hayalinizdeki Gülüşe<br />
                <span className="italic text-[var(--color-accent)] font-normal">Bir Adım</span> Uzakta
              </h2>
              <p className="text-[#8c857b] leading-relaxed max-w-[480px] font-light text-[15px]">
            ...
            <div className="flex flex-col gap-8 max-w-[480px]">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <a href={`tel:${siteConfig.contact.phone}`} className="text-[16px] text-white hover:text-[var(--color-accent)] transition-colors duration-300 font-light">
                      {siteConfig.contact.phone} <span className="text-[11px] text-white/40 ml-2">(Klinik Sabit Hat)</span>
                    </a>
                    {siteConfig.contact.phone2 && (
                      <a href={`tel:${siteConfig.contact.phone2}`} className="text-[16px] text-white hover:text-[var(--color-accent)] transition-colors duration-300 font-light">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href={`mailto:${siteConfig.contact.email}`} className="text-[16px] text-white hover:text-[var(--color-accent)] transition-colors duration-300 font-light">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <a href={siteConfig.url} target="_blank" rel="noopener noreferrer" className="text-[16px] text-white hover:text-[var(--color-accent)] transition-colors duration-300 font-light">
                      dthakansaylam.com
                    </a>
                    <a href="https://instagram.com/dthakansaylam" target="_blank" rel="noopener noreferrer" className="text-[16px] text-white hover:text-[var(--color-accent)] transition-colors duration-300 font-light flex items-center gap-1.5">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-white font-light leading-relaxed max-w-[380px]">{siteConfig.contact.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-white font-light">{siteConfig.contact.hours}</p>
                </div>
              </div>
            </div>
          ...
          {/* RIGHT COLUMN — Form Card stretches to fill the space */}
          <div className="w-full bg-[rgba(10,18,22,0.45)] border border-[rgba(202,168,105,0.22)] rounded-[22px] p-6 sm:p-10 lg:p-12 shadow-[0_25px_60px_rgba(0,0,0,0.55)] backdrop-blur-md relative">
            {/* Gold top line */}
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-[22px]">
              ...
              <div className="flex flex-col gap-2 col-span-2 sm:col-span-1">
                ...
                <input id="name" type="text" required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="h-[58px] w-full bg-[rgba(2,5,7,0.4)] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] text-[15px] rounded-[12px] outline-none transition-all duration-300 placeholder:text-white/15" placeholder="Adınız Soyadınız" />
              </div>
              ...
              <div className="flex flex-col gap-2 col-span-2 sm:col-span-1">
                ...
                <input id="phone" type="tel" required value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} className="h-[58px] w-full bg-[rgba(2,5,7,0.4)] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] text-[15px] rounded-[12px] outline-none transition-all duration-300 placeholder:text-white/15" placeholder="+90 5XX XXX XX XX" />
              </div>
              ...
              <div className="flex flex-col gap-2 col-span-2 sm:col-span-1">
                ...
                <input id="email" type="email" required value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="h-[58px] w-full bg-[rgba(2,5,7,0.4)] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] text-[15px] rounded-[12px] outline-none transition-all duration-300 placeholder:text-white/15" placeholder="ornek@dthakansaylam.com" />
              </div>
              ...
              <div className="flex flex-col gap-2 col-span-2 sm:col-span-1">
                ...
                <div className="relative">
                  <select id="service" value={form.service} onChange={(e) => setForm({ ...form, service: e.target.value })} className="h-[58px] w-full bg-[#050b0d] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] text-[15px] rounded-[12px] outline-none transition-all duration-300 appearance-none cursor-pointer">
                  ...
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none opacity-40">
                    <svg width="8" height="5" viewBox="0 0 8 5" fill="none"><path d="M1 1L4 4L7 1" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 col-span-2">
                ...
                <div className="relative">
                  <select id="timeframe" value={form.timeframe} onChange={(e) => setForm({ ...form, timeframe: e.target.value })} className="h-[58px] w-full bg-[#050b0d] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] text-[15px] rounded-[12px] outline-none transition-all duration-300 appearance-none cursor-pointer">
              ...
              <div className="flex flex-col gap-2 col-span-2">
                ...
                <textarea id="message" rows={4} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="min-h-[160px] w-full bg-[rgba(2,5,7,0.4)] border border-white/5 focus:border-[var(--color-accent)] focus:bg-[rgba(2,5,7,0.7)] text-white px-[18px] py-4 text-[15px] rounded-[12px] outline-none transition-all duration-300 placeholder:text-white/15 resize-y font-light" placeholder="Şikayetleriniz veya belirtmek istediğiniz sorular..." />
              </div>

              {/* Submit — Full Width */}
              <div className="col-span-2 pt-2">
                <button type="submit" className={`h-[60px] w-full flex items-center justify-center gap-3 text-[13px] font-bold tracking-[0.2em] uppercase transition-all duration-300 rounded-[12px] cursor-pointer hover:-translate-y-[2px] ${submitted ? "bg-emerald-800 text-white border-none" : "bg-[var(--color-accent)] text-[#04090d] hover:bg-[var(--color-accent-light)] shadow-[0_10px_25px_rgba(202,168,105,0.2)]"}`}>
